...
async def email_verification(token: str, backgroundtask:BackgroundTasks, session=Depends(get_db)):
    ...
    Args:
        ...
        raises:
        404 not found for email not found, 400 Bad request for email already verified, 401 unauthorize for invalid or expired token, 500 for internal server error
    Returns:
